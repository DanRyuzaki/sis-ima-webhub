...
class RegistrarSixthSection extends StatefulWidget {
  final int userType;

  const RegistrarSixthSection({
    required this.userType,
  });

  @override
  State<RegistrarSixthSection> createState() => _ManageCalendarState();
}

class _ManageCalendarState extends State<RegistrarSixthSection> {
